...
class CommentService {
  ...
  static Future<BaseResponse<SearchResponse<CommentModel>>> getComments(
    ...
    final BaseResponse<SearchResponse<CommentModel>> result =
  ...
  static Future<BaseResponse<CommentModel>> createComment(
    String text,
    String videoId,
  ) async {
  ...
  static Future<BaseResponse<CommentModel>> editComment(
    String commentId,
    String text,
  ) async {
